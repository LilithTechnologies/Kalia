...
public final class CeleritasVideoOptionsScreen extends Screen {
    ...
    public CeleritasVideoOptionsScreen(Screen parent) {
        this.parent = parent;
        this.controller = new CeleritasVideoOptionsController(
                () -> this.client.setScreen(this.parent),
                List.of(CeleritasOptionPages.general(), CeleritasOptionPages.quality(),
                        CeleritasOptionPages.performance(), CeleritasOptionPages.advanced()),
                this.context) {
            @Override
