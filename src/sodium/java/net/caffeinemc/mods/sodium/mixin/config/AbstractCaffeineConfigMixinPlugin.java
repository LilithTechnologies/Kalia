...
public abstract class AbstractCaffeineConfigMixinPlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        ...
        try {
            this.sodiumConfig = MixinConfig.load(new File("./config/kalia-mixins.properties"));
        } catch (Exception e) {
            throw new RuntimeException("Could not load configuration file for Kalia", e);
        }
    }
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.startsWith("dev.vexor.kalia.mixin.sodium")) {
            String mixin = mixinClassName.substring("dev.vexor.kalia.mixin.sodium.".length());
        ...
        } else if (mixinClassName.startsWith("dev.vexor.kalia.mixin.extra")) {
