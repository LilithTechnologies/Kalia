...
public class MixinConfig {
    protected static final Logger LOGGER = LogManager.getLogger("Graphite/Config");

    protected static final String JSON_KEY_SODIUM_OPTIONS = ":options";
    ...
    private static void writeDefaultConfig(File file) throws IOException {
        ...
        try (Writer writer = new FileWriter(file)) {
            writer.write("# This is the configuration file for Kalia.\n");
            writer.write("#\n");
