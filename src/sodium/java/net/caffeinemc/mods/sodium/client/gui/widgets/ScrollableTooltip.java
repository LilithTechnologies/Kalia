...
public class ScrollableTooltip extends DrawableHelper {
    private static final int VANILLA_TOOLTIP_BACKGROUND = 0xF0100010;
    private static final int VANILLA_TOOLTIP_BORDER_TOP = 0x505000FF;
    private static final int VANILLA_TOOLTIP_BORDER_BOTTOM = 0x5028007F;
    ...
    public void render() {
        ...
        ScissorUtil.withScissor(this.visibleDim.x(), this.visibleDim.y(), this.visibleDim.width(), this.visibleDim.height(), () -> {
            ...
            // Classic vanilla tooltip box: near-black purple background with the
            // signature purple gradient border (the same colors item tooltips use).
            int x1 = this.visibleDim.x();
            int y1 = this.visibleDim.y();
            int x2 = this.visibleDim.getLimitX();
