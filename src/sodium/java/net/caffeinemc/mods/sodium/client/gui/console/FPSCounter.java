...
public class FPSCounter {
    ...
    public void render() {
        ...
        boolean dirty = displayText.isEmpty();
        ...
        // Only re-format when a value actually updated; a stable string also keeps the
        // cached text mesh warm instead of re-baking every frame.
        if (dirty) {
        ...
        minecraft.textRenderer.drawWithShadow(displayText, 2, 2, 0xFFFFFF);
    }
