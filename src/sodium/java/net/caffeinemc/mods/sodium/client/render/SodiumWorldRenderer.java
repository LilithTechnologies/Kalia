...
public class SodiumWorldRenderer {
    ...
    // Per-frame scratch so setupTerrain does not allocate a fresh matrix every frame.
    ...
    public void setupTerrain(Viewport viewport,
        ...
        Matrix4f projectionMatrix = this.projectionScratch.set(MatrixState.INSTANCE.projection());
        ...
        this.lastProjectionMatrix.set(projectionMatrix);
    ...
    private void initRenderer(CommandList commandList) {
        ...
        var tracker = ChunkTrackerHolder.get(this.level);
        var readyChunks = tracker.getReadyChunks();
