...
import net.caffeinemc.mods.sodium.legacy.compat.mojang.minecraft.math.QuartPos;
import net.caffeinemc.mods.sodium.legacy.compat.mojang.minecraft.random.LinearCongruentialGenerator;
