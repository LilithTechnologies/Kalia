...
public class LaunchWarn {
    ...
    private static final String RICH_MESSAGE =
            "<html>" +
                    ...
                    "You have tried to launch Graphite (a Minecraft mod) directly, but it is not an executable program or mod installer. Instead, " +
    ...
    private static final String FAILED_TO_BROWSE_MESSAGE =
            "<html>" +
                    ...
                    "</body>" +
                    "</html>";
    public static final String WINDOW_TITLE = "Kalia";
