...
public class ConfigLoaderFabric {
    private static ConfigManager.ModMetadata getModMetadata(String modId) {
        var mod = FabricLoader.getInstance().getModContainer("kalia").orElseThrow(NullPointerException::new);
    ...
    public static void collectConfigEntryPoints() {
        ...
        ConfigManager.registerConfigEntryPoint(SodiumConfigBuilder::new, "kalia");
    }
}