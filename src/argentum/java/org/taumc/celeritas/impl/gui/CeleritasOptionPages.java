    ...
    static OptionPage general() {
        ...
        OptionGroup window = OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(int.class, VANILLA)
                        ...
                        .setBinding((options, value) -> {
                            ...
                            minecraft.currentScreen.resize(minecraft, scaledWindow.getWidth(), scaledWindow.getHeight());
                ...
                .add(OptionImpl.createBuilder(int.class, VANILLA)
                        ...
                        .setBinding((options, value) -> {
                            ...
                            KaliaHooks.setVsync(options.vsync);
        ...
        OptionGroup indicators = OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, VANILLA)
                        ...
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.bobView = value, options -> options.bobView)
                        .build())
                .build();
    ...
    static OptionPage quality() {
        OptionGroup graphics = OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, VANILLA)
                        ...
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.anaglyph3d = value, options -> options.anaglyph3d)
        ...
        OptionGroup details = OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(int.class, VANILLA)
                        ...
                        .setBinding((options, value) -> options.cloudMode = value,
                                options -> options.cloudMode)
                ...
                .add(OptionImpl.createBuilder(int.class, VANILLA)
                        ...
                        .setBinding((options, value) -> options.particle = value, options -> options.particle)
                ...
                .add(OptionImpl.createBuilder(int.class, VANILLA)
                        ...
                        .setBinding((options, value) -> options.ao = value,
                                options -> options.ao)
                        .setImpact(OptionImpact.LOW)
                        .setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD)
                        .build())
